<script lang="ts">
    ...
    import type { RentContractStatus } from "$lib/open-api";
    ...
    function getStatusInfo(status: RentContractStatus | undefined): {
        text: string;
        bgClass: string;
    } {
        if (!status) return { text: "-", bgClass: "bg-gray-100 text-gray-800" };
